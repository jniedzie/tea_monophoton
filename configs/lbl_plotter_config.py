...
for prefix in ["", "Barrel_", "EndCap_"]:
  ...
  histograms += (
    ...
    Histogram(f"goodPhoton_{prefix}swissCross", "", False, True, default_lumi, 20, 0, 1.5, 1e-2, 5e10, "Swiss cross", y_label, "", lbl_error),
    ...
    Histogram(
      f"goodPhoton_{prefix}seedTime_gt50p0GeV", "", False, True, default_lumi, 2, -4, 4, 1e-2, 5e6, "Photon seed time (ns)", y_label, "",
      lbl_error
    ),
    ...
    Histogram(
      f"goodPhoton_{prefix}SCEtaWidth", "", False, True, default_lumi, 5, 0, 0.03, 1e-2, 5e5, "#eta^{SC} width", y_label, "", lbl_error
    ),
    Histogram(
      f"goodPhoton_{prefix}SCPhiWidth", "", False, True, default_lumi, 5, 0, 0.05, 1e-2, 5e5, "#phi^{SC} width", y_label, "", lbl_error
    ),

    # Histogram(f"goodPhoton_{prefix}verticalOverCentral", "", False, True, default_lumi, 15,   0, 0.5, 1e-2, 3e5, "E_{top+bottom}/(2*E_{max})", y_label, "", lbl_error),
    # Histogram(f"goodPhoton_{prefix}horizontalOverCentral", "", False, True, default_lumi, 15,   0, 0.5, 1e-2, 3e5, "E_{right+left}/(2*E_{max})", y_label, "", lbl_error),
    Histogram(
      f"goodPhoton_{prefix}verticalOverCentral", "", False, True, default_lumi, 1, 0, 0.05, 1e-2, 3e5, "E_{right+left}/(2*E_{max})",
      y_label, "", lbl_error
    ),
    Histogram(
      f"goodPhoton_{prefix}horizontalOverCentral", "", False, True, default_lumi, 1, 0, 0.05, 1e-2, 3e5, "E_{top+bottom}/(2*E_{max})",
      y_label, "", lbl_error
    ),
    ...
    Histogram(
      f"goodPhoton_{prefix}verticalImbalance", "", False, True, default_lumi, 1, -1.1, 1.1, 1e-3, 3e5, "E_{top-bottom}/E_{top+bottom}",
      y_label, "", lbl_error
    ),
    Histogram(
      f"goodPhoton_{prefix}horizontalImbalance", "", False, True, default_lumi, 1, -1.1, 1.1, 1e-3, 3e5, "E_{left-right}/E_{left+right}",
      y_label, "", lbl_error
    ),
    Histogram(
      f"goodPhoton_{prefix}sigmaEta2012", "", False, True, default_lumi, 1, 0, 0.06, 1e-1, 3e5, "#sigma_{#eta, 2012}", y_label, "",
      lbl_error
    ),
    Histogram(
      f"goodPhoton_{prefix}sigmaIEtaIEta2012", "", False, True, default_lumi, 1, 0, 0.06, 1e-1, 3e5, "#sigma_{i#eta i#eta, 2012}", y_label,
      "", lbl_error
    ),
